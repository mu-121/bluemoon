...
function TopCollection() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-2xl font-bold text-center mb-8">Top Collections Over Last 24 Hours</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                {item.images.map((image, imgIndex) => (
                  <img
                    key={imgIndex}
                    src={image.src}
                    style={{ height: image.height, width: image.width, marginTop:image.marginTop, marginLeft: image.marginLeft,marginRight:image.marginRight }}
                    alt={`image ${imgIndex}`}
